...
import { DotsThree, DotsThreeVertical, Download, DownloadSimple, Image } from 'phosphor-react';
        ...
        width:"max-content",}}>
             <Stack spacing={2}>
                <Stack p={2} spacing={3} alignItems="center" sx={{backgroundColor:theme.palette.background.paper,borderRadius:1}}>
                    <img src={el.preview} alt={el.message} style={{maxHeight:210,borderRadius:"10px"}}></img>
                    <Stack spacing={2}>
