...
import { Bell, Camera, CaretRight, Phone, Prohibit, Star, Trash, VideoCamera, X } from 'phosphor-react';
        ...
        <Stack sx={{height:"100%",position:"relative",flexGrow:1,overflowY:"scroll"}} p={3} spacing={3}>
            <Stack alignItems={"center"} direction="row" spacing={2}>
                ...
                <Stack spacing={0.5} direction="column">
                    ...
                    <Typography variant="body2" fontWeight={500}>{"+91 9797211775"}</Typography>
                </Stack>
            </Stack>
            ...
            <Stack direction="row" alignItems={"center"} justifyContent="space-between">
                ...
                <Button onClick={()=>{
                    return dispatch(UpdateSiderbarType('SHARED'));
                }} endIcon={<CaretRight/>}>
                    401
                </Button>
            </Stack>
            ...
            <Stack direction="row" alignItems={"center"} justifyContent="space-between">
                <Stack direction="row" alignItems="center" spacing={2}>
                    <Star size={21}/>
                    <Typography variant="substitle2">Starred Messages</Typography>
                </Stack>
                <IconButton onClick={()=>{
                    return dispatch(UpdateSiderbarType('STARRED'));
                }}>
                    <CaretRight />
                </IconButton>
            </Stack>
            ...
            <Stack direction="row" alignItems={"center"} justifyContent="space-between">
                <Stack direction="row" alignItems="center" spacing={2}>
                    <Bell size={21}/>
                    <Typography variant="substitle2">Mute Notifications</Typography>
                </Stack>
                <AntSwitch />
            </Stack>
            <Divider />
            <Typography variant="subtitle2">Groups in Common</Typography>
            <Stack direction="row" spacing={2} alignItems={"center"}>
                <Avatar src={faker.image.avatar()} alt={faker.name.fullName()}></Avatar>
                <Stack spacing={.5}>
                    <Typography variant="subtitle2">CodingMonk</Typography>
                    <Typography variant="caption">Owl,Parrot,Wolf, You</Typography>
                </Stack>
            </Stack>
            <Stack direction="row" alingItems="center" spacing={2}>
                <Button onClick={()=>{
                    setOpenBlock(true)
